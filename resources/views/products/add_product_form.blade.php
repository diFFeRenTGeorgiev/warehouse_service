...
@section('content')
    ...
    <form id="product_form" action="{{!isset($product)?route('create_product'):route('edit_product') }}" method="POST" enctype="multipart/form-data">
        ...
        <div id="form" class="form-wrapper">
                        ...
                        <div class="row">
                            <div class="col-sm-2 imgUp">
                                ...
                                <label class="btn btn-primary">
                                    Upload<input type="file" name="product_files[]" class="uploadFile img form-control"
                                                 accept="image/*" value="Upload Photo"
            ...
            <fieldset class="number-label" id="numFields">
                <div class="box">
                    <div>
...
@section('page_css')
    <style>
        ...
        .form-wrapper #numFields .input-wrapper{
            width: 27%;
        ...
        /*.form-wrapper fieldset input, fieldset .number-label{*/
        /*width:20% !important;*/
        /*}*/
        .box {
            display: block ruby;
